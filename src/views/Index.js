...
function formatTrackTime(time) {
  ...
  seconds = seconds % 60;
  let time_string =
    pad(minutes, 2) + ":" + pad(seconds, 2) + "." + pad(msec, 3);
  return time_string;
}
      ...
      <Container maxWidth="false" style={{ height: "100vh" }}>
        ...
        >
          <a
            ...
            href="mtasa://mta.leguaan.ee:22003"
          >
            <b>mtasa://mta.leguaan.ee</b>
          </a>
        </Typography>
        {!isLoaded && (
        ...
        {isPointsError && (
          <Typography
            ...
            variant="h6"
          >
            An error occured while downloading points info, contact hoxi or
            iguana with the console output
          </Typography>
        )}
        ...
        {isTrackRecordsError && (
          <Typography
            ...
            variant="h6"
          >
            An error occured while downloading track records info, contact hoxi
            or iguana with the console output
          </Typography>
        )}
            ...
            <Grid container justifyContent="center" spacing={5}>
              <Grid item>
                <Typography variant="h5" align="center">
                  <b>World Drivers' Championship standings</b>
                </Typography>
                <br />
                    ...
                    <TableBody>
                      {pointsLB.map((placement) => (
                        <TableRow key={placement.rank}>
                          ...
                          <TableCell>
                            {moment(placement.last_updated + "Z").format(
                              "YYYY-MM-DD HH:mm:ss"
                            )}
                          </TableCell>
                        </TableRow>
                        ...
                        <TableRow key={record.time}>
                          ...
                          <TableCell>
                            <Link
                              ...
                              to={`/track_times?track=${encodeURI(record.map)}`}
                            >
                              {record.map}
                            </Link>
                          </TableCell>
